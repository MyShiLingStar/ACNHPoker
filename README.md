# >>★ _The legacy version of ACNHPoker has now been archived. You can find the new version at the [New Repository](https://github.com/MyShiLingStar/ACNHPokerCore)_ ★<<
　
 　
  　
   　
